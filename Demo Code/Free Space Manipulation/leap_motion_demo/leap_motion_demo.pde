...
void draw() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    // Drawing
    //hand.draw();
    float z = hand.getMiddleFinger().getPosition().y;
    
    println("" + z + "," + map(z,300,800,0,50));

translate(width/2,height/2);
  scale(10+map(z,200,500,0,40));
  
image(map, -50,-50,100,100);

 myPort.write("" + (int)map(z,300,800,0,50));
